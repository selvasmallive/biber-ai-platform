...
To expose that read-model status, explorer overview, block list, and transaction
list through the local read-only HTTP server, pass both explicit Postgres flags.
