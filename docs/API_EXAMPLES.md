...
python scripts/biber_agent_client.py --json save-github \
  ...
  --output /workspace/outputs/github-save-dry-run.json
python scripts/biber_agent_client.py --json create-pr \
  ...
  --title "Save generated BIBER example" \
  --body "Generated by BIBER and ready for review." \
  --output /workspace/outputs/github-pr-dry-run.json
...
python scripts/biber_agent_client.py show-repair-chain-list \
  /workspace/outputs/biber-mvp-loop-repair-chain-list.json
...
python scripts/biber_agent_client.py list-ready-repair-chain-eval-candidate-reviews \
  ...
  --ready-only \
  --limit 10 \
  --output /workspace/outputs/biber-mvp-loop-ready-repair-chain-eval-candidate-review-list.json
python scripts/biber_agent_client.py show-ready-repair-chain-eval-candidate-review-list \
  /workspace/outputs/biber-mvp-loop-ready-repair-chain-eval-candidate-review-list.json
...
python scripts/biber_agent_client.py list-ready-repair-chain-eval-dataset-validations \
  ...
  --ok-only \
  --limit 10 \
  --output /workspace/outputs/biber-mvp-loop-ready-repair-chain-eval-dataset-validation-list.json
python scripts/biber_agent_client.py show-ready-repair-chain-eval-dataset-validation-list \
  /workspace/outputs/biber-mvp-loop-ready-repair-chain-eval-dataset-validation-list.json
