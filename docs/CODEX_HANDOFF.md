...
- Vast code verification is current through `22566dc`. Full Rust/private-devnet
  ...
  export verification is current through `22566dc`; Rust/XRIQ live
...
- Current serving state:
  ...
  - Vast code verification is current through `22566dc`. If later docs-only
...
12. Treat these as first-class BIBER MVP/Replit-replacement workflow goals
   ...
   `diagnose-test` and can attach it automatically to failed `run-test`
    ...
    keeping training and GitHub save blocked.
...
13. Continue the XRIQ private-devnet prototype after the Rust/XRIQ model loop is
   ...
   keeping training and GitHub save blocked. The
   ...
   `export-ready-repair-chain-eval-dataset`) against a real user
