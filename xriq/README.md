...
wallet account history, audit events, snapshot list, node status, and indexer
status through the local read-only HTTP server, pass both explicit Postgres flags.
