...
pub use config::{
    ...
    PRIVATE_DEVNET_MIN_FEE_BASE_UNITS, PUBLIC_TESTNET_AUTHORITY_ADDRESS, PUBLIC_TESTNET_CHAIN_ID,
    PUBLIC_TESTNET_FAUCET_ADDRESS, PUBLIC_TESTNET_FAUCET_BALANCE_BASE_UNITS,
    PUBLIC_TESTNET_FAUCET_DRIP_BASE_UNITS, PUBLIC_TESTNET_FAUCET_MAX_BALANCE_BASE_UNITS,
    PUBLIC_TESTNET_FEE_SINK_ADDRESS, PUBLIC_TESTNET_MAX_TRANSACTIONS_PER_BLOCK,
    PUBLIC_TESTNET_MEMPOOL_MAX_TRANSACTIONS, PUBLIC_TESTNET_MIN_FEE_BASE_UNITS,
};
