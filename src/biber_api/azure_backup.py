...
class AzureBlobBackup:
    ...
    def enabled(self) -> bool:
        return bool(self._settings.azure_storage_connection_string)
    ...
    async def upload_json(self, blob_name: str, payload: dict[str, Any]) -> str:
        ...
        def _upload() -> str:
            ...
            service = BlobServiceClient.from_connection_string(
                self._settings.azure_storage_connection_string or ""
            )
            container = service.get_container_client(self._settings.azure_blob_container)
